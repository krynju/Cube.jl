...
draw_lines:
    ...
    ;add r9, 54		; add header offset ; COMMENTED BECAUSE NO HEADER IN JULIA VERSION
    ...
    cmp rbx, 786486-54          ; check boundaries to prevent segfaults
    jge .skip_pixel_draw        ; todo add bitmap size as define here instead of size hardcode
    cmp rbx, 0
    jl  .skip_pixel_draw

    mov [r9+rbx], BYTE 0xff    ; fill red channel
    mov [r9+rbx+1], BYTE 0xff  ; fill green channel
    mov [r9+rbx+2], BYTE 0xff  ; fill blue channel
